...
Por lo pronto, iniciar no requiere más trabajo que el uso de `peru_transparencia_economica()`. Este documento busca explicar con mayor detalle la manera en que se deben definir los parámetros pasados a las funciones `elegir_*()` para, en combinación con `consultar()`, poder hacer consultas exitosas.
...
```{r}
pp0031_departamentos <- peru_transparencia_economica() |> 
    elegir_periodo_anual(2021) |> 
