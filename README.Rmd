...
Para iniciar una consulta tan solo hace falta usar la función `peru_transparencia_economica()`. Esto crea un dataframe vacío y muestra los parámetros de consulta agregados. Al inicio no tenemos parámetros ni data.
