...
es contar con una manera de obtener datos del Portal de Transparencia
Económica Perú con una interfaz de programación consistente y escalable.
...
En ambos módulos, la mínima requerida es
[`elegir_periodo_anual()`](https://perutranspaeconomica.samuelenrique.com/reference/elegir_periodo_anual.md).
...
Con excepción de
[`elegir_periodo_anual()`](https://perutranspaeconomica.samuelenrique.com/reference/elegir_periodo_anual.md),
es necesario que las funciones `elegir_*()` tengan, en su conjunto, al
menos un argumento definido como `"todos"`. Más adelante se verá que en
caso contrario la consulta no prosperará.
...
[`help("elegir_quien_gasta")`](https://perutranspaeconomica.samuelenrique.com/reference/elegir_institucion.md)
o
[`?elegir_quien_gasta`](https://perutranspaeconomica.samuelenrique.com/reference/elegir_institucion.md).
...
excepción de
[`elegir_periodo_anual()`](https://perutranspaeconomica.samuelenrique.com/reference/elegir_periodo_anual.md))
no cuenta con ningún parámetro como definido como `"todos"`.
